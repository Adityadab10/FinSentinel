...
export default function DashboardPage() {
  ...
  const { distribution, isLoading: distributionLoading } = useRiskDistribution();
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
          {distributionLoading ? (
            ...
            >
              ...
              <p className="text-sm text-muted-foreground">Transaction risk breakdown</p>
              {distribution && <RiskDistributionChart data={distribution} />}
            </motion.div>
          )}
